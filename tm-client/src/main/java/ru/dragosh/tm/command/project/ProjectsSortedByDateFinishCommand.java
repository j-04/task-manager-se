...
public final class ProjectsSortedByDateFinishCommand extends AbstractCommand {
    @NotNull
    @Override
    ...
    public void execute() throws Exception_Exception {
        ...
        projectEndPoint.getSortedByDateFinish(session).getProjectList().forEach(ConsoleUtil::projectOutput);
    }
}
