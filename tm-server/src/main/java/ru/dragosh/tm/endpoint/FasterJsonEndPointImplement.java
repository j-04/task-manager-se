...
public final class FasterJsonEndPointImplement implements FasterJsonEndPoint {
    @NotNull
    private ServiceLocator serviceLocator;

    public FasterJsonEndPointImplement(@NotNull final ServiceLocator serviceLocator) {
    ...
    public void save(@Nullable final SessionDTO sessionDTO) throws Exception {
        ...
        serviceLocator.getFasterJsonServiceImplement().save(domain);
    }
    ...
    public void load(@Nullable final SessionDTO sessionDTO) throws Exception {
        ...
        serviceLocator.getSessionService().validate(session);
        serviceLocator.getSessionService().validate(session, RoleType.ADMIN);
        @Nullable final Domain domain = serviceLocator.getFasterJsonServiceImplement().Load();
        if (domain == null)
            throw new AccessForbiddenException();
